...
def readout():
    ...
    class sample:
        def __init__(self, name, gepfit, celfit, cphfit, spin, tc, tdeb, muat, dx, dy, dz, apc, asf, inimag, kappa, locmom, locspin, model):
            ...
            self.arbsc=self.R/self.tc**2*self.J/sp.k
    ...
    initemp=300.                        #initial temperature of electron and phonon bath [K]

    #gaussian pulse parameters
    pump_power=6e21                           #power of optical pulse in W/m^3
    pump_sigma=0.034e-12                     #sigma of gaussian pulse in s
    ...
    param={'gepf': sam.gepfit, 'celf': sam.celfit, 'cphf': sam.cphfit, 'ss': samplesize, 's':sam.spin, 'tc':sam.tc,
           ...
           'lambda':lamda, 'sdrate':sdrate, 'rhosd':rhosd, 'sdissrate':sdissrate, 'locspin':sam.locspin, 'locmom':sam.locmom, 'Jloc':sam.Jloc}
